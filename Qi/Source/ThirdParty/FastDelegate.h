...
// 28-Apr-04 1.1  * Prevent most unsafe uses of evil static function work around.
...
//				  * Improved warning and error messages. Non-standard work arounds
...
//					 MSVC and Intel now use a clever work around invented by John Dlugosz:
...
// 25-Jul-08 1.5.1* Cleaned up documentation
...
#define FASTDELEGATE_USESTATICFUNCTIONWORKAROUND
...
// Prevent use of the static function work around with the DOS medium model.
#ifdef __MEDIUM__
#undef FASTDELEGATE_USESTATICFUNCTIONWORKAROUND
#endif
...
// Work around for Microsoft and Intel (IA32 and Itanium)
template<>
...
// But a very clever work around invented by John M. Dlugosz solves this problem.
...
// Work around for Microsoft Visual C++ 6.0
...
#if !defined(FASTDELEGATE_USESTATICFUNCTIONWORKAROUND)
...
// There's also a straightforward work around, that won't work on DOS compilers using the
...
// support static_cast between void * and function pointers.
	...
	inline void bindstaticfunc(DerivedClass *pParent, ParentInvokerSig static_function_invoker, 
		...
		// WARNING! Evil work around. We store the function in the 'this' pointer!
		// Ensure that there's a compilation failure if function pointers 
		// and data pointers have different sizes.
		// If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONWORKAROUND.
...
#endif // !defined(FASTDELEGATE_USESTATICFUNCTIONWORKAROUND)
